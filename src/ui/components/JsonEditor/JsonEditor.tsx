...
export const JsonEditor = forwardRef<JsonEditorHandle, JsonEditorProps>(
  function JsonEditor({ value, onChange, parseError, validationErrors, fontSize, onFontSizeChange, canUndo, canRedo, onUndo, onRedo, highlightedLines, onErrorClick }, ref) {
      ...
      <div className={styles.container}>
        <div className={styles.editorHeader}>
          ...
          <div className={styles.headerActions}>
            ...
            <button className={styles.prettifyButton} onClick={handlePrettify} title="Prettify JSON (Ctrl+Shift+F)" type="button">
              {'{ }'}
            </button>
          </div>
        </div>
