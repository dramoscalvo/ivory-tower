...
export const UmlCanvas = forwardRef<UmlCanvasHandle, UmlCanvasProps>(
  function UmlCanvas({ layout, onEntityClick }, ref) {
      ...
      >
        ...
        >
          ...
          {layout.titlePosition && (
            <text
              x={layout.titlePosition.x}
              y={layout.titlePosition.y}
