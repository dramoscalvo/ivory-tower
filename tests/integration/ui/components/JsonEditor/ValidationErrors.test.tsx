...
describe('ValidationErrors', () => {
  describe('when there are no errors', () => {
    it('renders nothing when parseError is null and validationErrors is empty', () => {
      const { container } = render(<ValidationErrors parseError={null} validationErrors={[]} />);
  ...
  describe('parse errors', () => {
    it('displays parse error message', () => {
      render(<ValidationErrors parseError="Unexpected token" validationErrors={[]} />);
  ...
  describe('combined errors', () => {
    it('displays both parse error and validation errors', () => {
      ...
      render(<ValidationErrors parseError="Parse failed" validationErrors={errors} />);
