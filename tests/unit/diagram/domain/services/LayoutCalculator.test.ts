...
describe('calculateLayout', () => {
  describe('entity sizing', () => {
    ...
    it('increases width for longer entity names', () => {
      ...
      const longDiagram = createDiagram([createMinimalEntity('b', 'VeryLongEntityNameThatExceedsMinimum')])
  ...
  describe('bounds calculation', () => {
    it('calculates bounds encompassing all entities', () => {
      ...
      expect(layout.bounds.width).toBeGreaterThan(
        lastEntity.position.x + lastEntity.size.width
      )
      expect(layout.bounds.height).toBeGreaterThan(
        lastEntity.position.y + lastEntity.size.height
      )
    })
  })
})
